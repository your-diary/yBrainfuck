...
#Algorithm:
#1. Converts the specified Brainfuck source `A.brainf` to a C source `A.brainf.c`.
#2. Compiles `A.brainf.c` using `gcc` and executes it.

#For usability, a number sign "#" and any text after it is ignored as a comment.

import subprocess
import sys

def print_usage() -> None:
    print("Usage: brainfuck <source>.brainf")
    sys.exit(0)
